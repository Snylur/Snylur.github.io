...
- Do you think mathematics is something we discover or something we create? And has your experience with mathematics changed your answer?
- *That's an interesting question! I don't think there's a binary here — I think mathematics is about creating certain objects, patterns, or restrictions, and then discovering their properties. So in that way, mathematics is a combination of creation and discovery. I haven't thought about this question deeply before, but I guess a long, long time ago I would've thought of mathematics as simply solving problems — neither creation nor discovery.* 
